...
<tr>
  ...
  <td><b>OTHER SHAREHOLDER(S),WHO IS NOT A DIRECTOR(IF ANY)</td>
    ...
    <td>a.</td>
    <td>Name:</td>
   <td><input type="text" name="shareholderName"  size="97" ></td>
    </tr>
	  <tr>
	<td></td>
  <td>I/C No./Company No:</td>
  <td><input type="text" name="shareholderICNo"  size="97" ></td>
    </tr>
	  <tr>
	  
	<td></td>
  <td>Nationality:</td>
   <td><input type="text" name="shareholderNationality"  size="97" ></td>
    </tr>
	  <tr>
	<td></td>	  
  <td>Race:</td>
   <td><input type="text" name="shareholderRace" size="97" ></td>
    </tr>
	
	<tr>
	<td></td>
  <td>Place of Incorporation(If it is a corporation):</td>
 <td><input type="text" name="shareholderPlace"  size="97" ></td>
  </tr>
  
  	  <tr>
	<td></td>
  <td>Residential Address/Registered Office Address (If it is a corporation):</td>
  <td><textarea name="shareholderAddress" rows="5" cols="100"></textarea></td>
    </tr>
  ...
  <td><input type="text" name="shareholderEmail"  size="97" ></td>
    </tr>
	<td></td>	  
  <td>Contact No.:</td>
  <td><input type="text" name="shareholderContact"  size="97" ></td>
    </tr>
	<td></td>	  
  <td>Designation(Individual)/Name of Official Corporate Representative:</td>
   <td><input type="text" name="shareholderDesignation"  size="97" ></td>
    </tr>
	<td></td>	  
  <td>Share(s) taken up:</td>
   <td><input type="text" name="shareholderShare" size="97" ></td>
    </tr>
   ...
   <td></td>
    ...
    <td>b.</td>
    <td>Name:</td>
   <td><input type="text" name="shareholderName2"  size="97" ></td>
    </tr>
	  <tr>
	<td></td>
  <td>I/C No./Company No:</td>
  <td><input type="text" name="shareholderICNo2"  size="97" ></td>
    </tr>
	  <tr>
	  
	<td></td>
  <td>Nationality:</td>
   <td><input type="text" name="shareholderNationality2"  size="97" ></td>
    </tr>
	  <tr>
	<td></td>	  
  <td>Race:</td>
   <td><input type="text" name="shareholderRace2" size="97" ></td>
    </tr>
	
	<tr>
	<td></td>
  <td>Place of Incorporation(If it is a corporation):</td>
 <td><input type="text" name="shareholderPlace2"  size="97" ></td>
  </tr>
  
  	  <tr>
	<td></td>
  <td>Residential Address/Registered Office Address (If it is a corporation):</td>
  <td><textarea name="shareholderAddress2" rows="5" cols="100"></textarea></td>
    </tr>
	...
	<td></td>	  
  <td>Email(Compulsory) :</td>
  <td><input type="text" name="shareholderEmail2"  size="97" ></td>
    </tr>
	<td></td>	  
  <td>Contact No.:</td>
  <td><input type="text" name="shareholderContact2"  size="97" ></td>
    </tr>
	<td></td>	  
  <td>Designation(Individual)/Name of Official Corporate Representative:</td>
   <td><input type="text" name="shareholderDesignation2"  size="97" ></td>
    </tr>
	<td></td>	  
  <td>Share(s) taken up:</td>
   <td><input type="text" name="shareholderShare2" size="97" ></td>
    </tr>
