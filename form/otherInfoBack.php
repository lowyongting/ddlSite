...
if (isset($_POST[''])){
 ...
 header("location: shareholderInfoBack.php");
 }
}
?>
...
<tr>
  ...
  <td><b>PARTICULARS OF NEXT OF KIN</td>
    ...
    <td>a.</td>
    <td>Name:</td>
   <td><input type="text" name="pName"  size="97" value="<?php echo$_SESSION['pName']; ?>" required ></td>
    </tr>
	  <tr>
	<td></td>
  <td>I/C No./Passport No:</td>
  <td><input type="text" name="pIC"  size="97" value="<?php echo$_SESSION['pIC']; ?>"></td>
    </tr>
	  <tr>
	  
	<td></td>
  <td>Nationality:</td>
   <td><input type="text" name="pNationality"  size="97" value="<?php echo$_SESSION['pNationality']; ?>"></td>
    </tr>
	  <tr>
	<td></td>	  
  <td>Race:</td>
   <td><input type="text" name="pRace" size="97" value="<?php echo$_SESSION['pRace']; ?>"></td>
    </tr>
  	  <tr>
	<td></td>
  <td>Residential Address/Registered Office Address (If it is a corporation):</td>
  <td><textarea name="pAddress" rows="5" cols="100"><?php echo $_SESSION['pAddress'];?></textarea></td>
    </tr>
	  <tr>
	<td></td>	  
  <td>Email(Compulsory):</td>
  <td><input type="email" name="pEmail"  size="97" value="<?php echo$_SESSION['pEmail']; ?>" required></td>
    </tr>
...
<tr>
  ...
  <td><b>OPENING OF COMPANY'S BANK ACCOUNT AFTER INCORPORATION</td>
    ...
    <td>a.</td>
    <td>Name of bank:</td>
   <td><input type="text" name="bank_Name"  size="97" value="<?php echo$_SESSION['bank_Name']; ?>"></td>
    </tr>
	  <tr>
	<td></td>
  <td>Bank Branch:</td>
  <td><input type="text" name="bank_Branch"  size="97" value="<?php echo$_SESSION['bank_Branch']; ?>"></td>
    </tr>
	  <tr>
	  
	<td></td>
  <td>Authorised Signatory(ies):</td>
  <td><textarea name="bank_Signatory" rows="2" cols="100"><?php echo $_SESSION['bank_Signatory'];?></textarea></td>
    </tr>
	  <tr>
	<td></td>	  
  <td>Conditions of signing cheque:</td>
  <td><textarea name="Bank_Conditions" rows="2" cols="100"><?php echo $_SESSION['Bank_Conditions'];?></textarea></td>
    </tr>
